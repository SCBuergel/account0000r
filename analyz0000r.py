...
def printAllAccountUse(accounts):
    accounts.sort(key=lambda x: (x['mnemonic'].lower(), x['index']))

    # Grouping by 'mnemonic' and printing each group in the specified format
